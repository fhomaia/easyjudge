...
export class JudgingService {
  ...
  // Funções especiais não dependem de template (SpecialRoleAssignment
  // é só por eventId) — método público reusável tanto por
  // getAssignments (tela de escala) quanto por quem só precisa saber
  // se uma função específica (ex: Jurado de Legalidade) já foi
  // preenchida, sem precisar escolher um sistema de pontuação primeiro
  // (ex: checklist de setup do evento).
