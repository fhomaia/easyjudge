...
export class CreateProgramProfilesAndCreatedBy1784080468336 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "programs" ALTER COLUMN "created_by_id" SET NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_b44b72ef368c7a57f4777d81b0" ON "programs" ("created_by_id") `);
        await queryRunner.query(`ALTER TABLE "programs" ADD CONSTRAINT "FK_b44b72ef368c7a57f4777d81b0f" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "program_profiles" ADD CONSTRAINT "FK_f539b331bc86eb3a9a1cecb55ee" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "program_profiles" DROP CONSTRAINT "FK_f539b331bc86eb3a9a1cecb55ee"`);
        await queryRunner.query(`ALTER TABLE "programs" DROP CONSTRAINT "FK_b44b72ef368c7a57f4777d81b0f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b44b72ef368c7a57f4777d81b0"`);
        await queryRunner.query(`ALTER TABLE "programs" DROP COLUMN "created_by_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f539b331bc86eb3a9a1cecb55e"`);
