...
export function CustomIntervalDialog({
  ...
  // STRING, não number — bug real 2026-08-05 (AutoGenerateDialog): com
  // state number direto, apagar o campo pra digitar outro valor manda
  // `e.target.value` vazio, `Number("")` vira `0`, e o input reexibe "0"
  // antes do usuário conseguir digitar. Conversão pra number só no
  // submit, com fallback pro mínimo (1) se ficar vazio/inválido.
